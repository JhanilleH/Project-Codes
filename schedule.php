...
<div class="toppane">
	...
	?> 
		...
		<td><button class= "btn-primary"><a href=delete.php?scheduleID=<?php echo $rows['scheduleID'];?>>Delete</a></button>
    ...
    <div id="myModal" class="modal">
        ...
        <div >
            ...
            <input type="datetime-local" name="dateEntered" id="modal-dateEntered" style="width: 300px; height: 70px;" >
            <br>
    ...
    <script>
        ...
        document.getElementById("modal-submit").addEventListener("click", ()=> {
            ...
            var dateEntered = document.getElementById("modal-dateEntered").value
